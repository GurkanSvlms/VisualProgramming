...
//  VisualProgramming
//
//  Created by Ali Gürkan Sevilmis on 10.05.2023.
//

import UIKit
import CoreData

class CustomerRequestController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let alert = UIAlertController(title: "Request", message: "Do you want to cancel the request?", preferredStyle: .alert)
